...
const PARTENAIRES: { src: string; alt: string }[] = [
  { src: '/partenaire/CNIN.webp', alt: 'CNIN' },
  { src: '/partenaire/CRIET.png', alt: 'CRIET' },
  { src: '/partenaire/institut_nationale_de_la_femme.jpg', alt: 'Institut national de la femme' },
  { src: '/partenaire/Offe.jpg', alt: 'OFFE' },
